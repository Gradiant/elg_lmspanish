...
from transformers import AutoTokenizer, pipeline, AutoConfig, FillMaskPipeline, \
...
def run_lmspanish():
    ...
    if (data.get('type') != 'structuredText') or (data is None) or ("texts" not in data):
